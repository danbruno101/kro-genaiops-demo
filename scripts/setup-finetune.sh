...
docker build -t genaiops/mock-trainer:demo "${HERE}/../monitoring/mock-trainer"
docker build -t genaiops/mock-drift:demo "${HERE}/../monitoring/mock-drift"
kind load docker-image genaiops/mock-trainer:demo --name "${CLUSTER}"
kind load docker-image genaiops/mock-drift:demo --name "${CLUSTER}"
